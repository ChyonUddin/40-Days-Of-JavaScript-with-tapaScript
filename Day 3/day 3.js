...
এই অপারেটরগুলো Boolean কনভার্সন না করেই সরাসরি মান রিটার্ন করে।

তাই এগুলো শর্ট সার্কিট ইভ্যালুয়েশন করে:

&& → প্রথম falsy পেলেই থামে।

|| → প্রথম truthy পেলেই থামে।

Truthy vs Falsy

Falsy Values: false, 0, "" (empty string), null, undefined, NaN

Truthy Values: বাকি সব কিছু (যেমন "Cow", "Horse", 123, {} ইত্যাদি)
...
typeof null; // "object" eta  ekta inbuild bug 


// instanceof   
console.log("**** instanceof ****")

// it use for nonprimitive data type check
 
//  //like object,[array{Array.isArray()}] and function 
